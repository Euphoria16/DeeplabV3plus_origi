...
class Trainer():
    ...
    def save_checkpoint(self, is_best, filename=None):
        ...
        :return:
        """
        if os.path.exists(os.path.join(self.args.checkpoint_dir, self.args.run_name)):
            pass
        else:
            os.mkdir(os.path.join(self.args.checkpoint_dir, self.args.run_name))
        filename = os.path.join(self.args.checkpoint_dir, self.args.run_name,filename)
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--gpu', type=str, default="1,3",
                            help=" the num of gpu")
    arg_parser.add_argument('--batch_size_per_gpu', default=16, type=int,
                            help='input batch size')

    # dataset related arguments
    arg_parser.add_argument('--dataset', default='voc2012_aug', type=str,
    ...
    arg_parser.add_argument('--poly_power', type=float, default=0.9,
                            help="poly_power")
    arg_parser.add_argument('--run_name',type=str,default='experiments',
