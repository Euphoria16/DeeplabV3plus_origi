...
class Voc_Dataset(data.Dataset):
    def __init__(self,
                 root_path='/home/data/voc/VOCdevkit',
                 dataset='voc2012_aug',
                 base_size=513,
                 crop_size=513,
                 is_training=True):
        ...
        if self.dataset == 'voc2007':
            ...
            self.data_path = os.path.join(root_path, "VOC2012")
            if is_training:
                item_list_filepath = '/home/xh/workspace/cascade_seg/train_aug.txt'
            else:
                item_list_filepath = os.path.join(self.data_path, "ImageSets/Segmentation/val.txt")
        ...
        self.gt_filepath = "/home/xh/workspace/SegmentationClassAug"
